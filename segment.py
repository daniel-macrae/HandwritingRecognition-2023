    ...
    def segment_page(self, image=None, path=''):
        ...
        for label in range(1, ret):
            ...
            for j,contour in enumerate(contours):
                    ...
                    filename = self.output_folder + f'/{image_name}_character_{j}_x={x}y={y}w={w}h={h}.png'
...
if __name__ == "__main__":
    ...
    a.segment_page(path="../image-data/image-data/P172-Fg001-R-C01-R01-binarized.jpg")
